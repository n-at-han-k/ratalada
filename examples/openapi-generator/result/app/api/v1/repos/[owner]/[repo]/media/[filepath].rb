...
# /repos/{owner}/{repo}/media/{filepath} -- scaffolded from the document.
...
RSpec.describe "/repos/{owner}/{repo}/media/{filepath}", type: :openapi do
  openapi_schema :public_api

  api_path "/repos/{owner}/{repo}/media/{filepath}" do
    parameter name: :owner, in: :path, schema: {"type" => "string"}, required: true
    parameter name: :repo, in: :path, schema: {"type" => "string"}, required: true
    parameter name: :filepath, in: :path, schema: {"type" => "string"}, required: true

    get "Get a file or it's LFS object from a repository" do
      tags "repository"
  ...
  it "GET /api/v1/repos/{owner}/{repo}/media/{filepath} answers 200" do
