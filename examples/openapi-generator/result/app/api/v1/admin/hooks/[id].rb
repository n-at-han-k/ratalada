...
# /admin/hooks/{id} -- scaffolded from the document.
...
RSpec.describe "/admin/hooks/{id}", type: :openapi do
  openapi_schema :public_api

  api_path "/admin/hooks/{id}" do
  ...
  it "GET /api/v1/admin/hooks/{id} answers 200" do
    Factory[:hook, :id => 1]
    assert_api_response :get, 200, path_params: {id: 1}
  end

  it "DELETE /api/v1/admin/hooks/{id} answers 204" do
    Factory[:hook, :id => 1]
    assert_api_response :delete, 204, path_params: {id: 1}
  end

  it "PATCH /api/v1/admin/hooks/{id} answers 200" do
    Factory[:hook, :id => 1]
