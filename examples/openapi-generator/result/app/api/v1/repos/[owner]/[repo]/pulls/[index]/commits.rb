...
# /repos/{owner}/{repo}/pulls/{index}/commits -- scaffolded from the document.
...
RSpec.describe "/repos/{owner}/{repo}/pulls/{index}/commits", type: :openapi do
  openapi_schema :public_api

  api_path "/repos/{owner}/{repo}/pulls/{index}/commits" do
    parameter name: :owner, in: :path, schema: {"type" => "string"}, required: true
    parameter name: :repo, in: :path, schema: {"type" => "string"}, required: true
    parameter name: :index, in: :path, schema: {"type" => "integer", "format" => "int64"}, required: true

    get "Get commits for a pull request" do
      tags "repository"
  ...
  it "GET /api/v1/repos/{owner}/{repo}/pulls/{index}/commits answers 200" do
