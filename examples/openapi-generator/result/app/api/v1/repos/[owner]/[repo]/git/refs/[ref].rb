...
# /repos/{owner}/{repo}/git/refs/{ref} -- scaffolded from the document.
...
RSpec.describe "/repos/{owner}/{repo}/git/refs/{ref}", type: :openapi do
  openapi_schema :public_api

  api_path "/repos/{owner}/{repo}/git/refs/{ref}" do
  ...
  it "GET /api/v1/repos/{owner}/{repo}/git/refs/{ref} answers 200" do
    Factory[:reference]
