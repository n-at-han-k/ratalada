...
# /user/actions/runners/jobs -- scaffolded from the document.
...
RSpec.describe "/user/actions/runners/jobs", type: :openapi do
  openapi_schema :public_api

  api_path "/user/actions/runners/jobs" do

    get "Search for user's action jobs according filter conditions" do
      tags "user"
  ...
  it "GET /api/v1/user/actions/runners/jobs answers 200" do
