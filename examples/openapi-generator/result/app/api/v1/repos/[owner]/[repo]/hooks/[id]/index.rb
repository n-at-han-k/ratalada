...
# /repos/{owner}/{repo}/hooks/{id} -- scaffolded from the document.
...
RSpec.describe "/repos/{owner}/{repo}/hooks/{id}", type: :openapi do
  openapi_schema :public_api

  api_path "/repos/{owner}/{repo}/hooks/{id}" do
    ...
    delete "Delete a hook in a repository" do
      tags "repository"
    ...
    patch "Edit a hook in a repository" do
      tags "repository"
  ...
  it "GET /api/v1/repos/{owner}/{repo}/hooks/{id} answers 200" do
    Factory[:hook, :id => 1]
    assert_api_response :get, 200, path_params: {owner: "owner", repo: "repo", id: 1}
  end

  it "DELETE /api/v1/repos/{owner}/{repo}/hooks/{id} answers 204" do
    Factory[:hook, :id => 1]
    assert_api_response :delete, 204, path_params: {owner: "owner", repo: "repo", id: 1}
  end

  it "PATCH /api/v1/repos/{owner}/{repo}/hooks/{id} answers 200" do
    Factory[:hook, :id => 1]
