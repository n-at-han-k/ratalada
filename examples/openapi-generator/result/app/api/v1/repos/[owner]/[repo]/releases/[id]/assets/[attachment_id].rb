...
# /repos/{owner}/{repo}/releases/{id}/assets/{attachment_id} -- scaffolded from the document.
...
RSpec.describe "/repos/{owner}/{repo}/releases/{id}/assets/{attachment_id}", type: :openapi do
  openapi_schema :public_api

  api_path "/repos/{owner}/{repo}/releases/{id}/assets/{attachment_id}" do
    ...
    get "Get a release attachment" do
      tags "repository"
    ...
    delete "Delete a release attachment" do
      tags "repository"
    ...
    patch "Edit a release attachment" do
      tags "repository"
  ...
  it "GET /api/v1/repos/{owner}/{repo}/releases/{id}/assets/{attachment_id} answers 200" do
    Factory[:attachment, :attachment_id => 0]
    assert_api_response :get, 200, path_params: {owner: "owner", repo: "repo", id: 0, attachment_id: 0}
  end

  it "DELETE /api/v1/repos/{owner}/{repo}/releases/{id}/assets/{attachment_id} answers 204" do
    Factory[:attachment, :attachment_id => 0]
    assert_api_response :delete, 204, path_params: {owner: "owner", repo: "repo", id: 0, attachment_id: 0}
  end

  it "PATCH /api/v1/repos/{owner}/{repo}/releases/{id}/assets/{attachment_id} answers 201" do
    Factory[:attachment, :attachment_id => 0]
