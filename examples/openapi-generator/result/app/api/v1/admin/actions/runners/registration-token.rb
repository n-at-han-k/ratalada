...
# /admin/actions/runners/registration-token -- scaffolded from the document.
...
RSpec.describe "/admin/actions/runners/registration-token", type: :openapi do
  openapi_schema :public_api

  api_path "/admin/actions/runners/registration-token" do
  ...
  it "GET /api/v1/admin/actions/runners/registration-token answers 200" do
