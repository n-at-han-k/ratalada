...
# /admin/actions/runners/{runner_id} -- scaffolded from the document.
...
RSpec.describe "/admin/actions/runners/{runner_id}", type: :openapi do
  openapi_schema :public_api

  api_path "/admin/actions/runners/{runner_id}" do
    parameter name: :runner_id, in: :path, schema: {"type" => "string"}, required: true

    get "Get a particular runner, no matter whether it is a global runner or scoped to an organization, user, or repository" do
      tags "admin"
    ...
    delete "Delete a particular runner, no matter whether it is a global runner or scoped to an organization, user, or repository" do
      tags "admin"
  ...
  it "GET /api/v1/admin/actions/runners/{runner_id} answers 200" do
    Factory[:action_runner, :runner_id => "runner_id"]
    assert_api_response :get, 200, path_params: {runner_id: "runner_id"}
  end

  it "DELETE /api/v1/admin/actions/runners/{runner_id} answers 204" do
    Factory[:action_runner, :runner_id => "runner_id"]
