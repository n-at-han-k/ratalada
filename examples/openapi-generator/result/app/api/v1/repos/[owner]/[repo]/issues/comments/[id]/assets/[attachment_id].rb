...
# /repos/{owner}/{repo}/issues/comments/{id}/assets/{attachment_id} -- scaffolded from the document.
...
RSpec.describe "/repos/{owner}/{repo}/issues/comments/{id}/assets/{attachment_id}", type: :openapi do
  openapi_schema :public_api

  api_path "/repos/{owner}/{repo}/issues/comments/{id}/assets/{attachment_id}" do
    ...
    get "Get a comment attachment" do
      tags "issue"
    ...
    delete "Delete a comment attachment" do
      tags "issue"
    ...
    patch "Edit a comment attachment" do
      tags "issue"
  ...
  it "GET /api/v1/repos/{owner}/{repo}/issues/comments/{id}/assets/{attachment_id} answers 200" do
    Factory[:attachment, :attachment_id => 0]
    assert_api_response :get, 200, path_params: {owner: "owner", repo: "repo", id: 0, attachment_id: 0}
  end

  it "DELETE /api/v1/repos/{owner}/{repo}/issues/comments/{id}/assets/{attachment_id} answers 204" do
    Factory[:attachment, :attachment_id => 0]
    assert_api_response :delete, 204, path_params: {owner: "owner", repo: "repo", id: 0, attachment_id: 0}
  end

  it "PATCH /api/v1/repos/{owner}/{repo}/issues/comments/{id}/assets/{attachment_id} answers 201" do
    Factory[:attachment, :attachment_id => 0]
    assert_api_response :patch, 201, path_params: {owner: "owner", repo: "repo", id: 0, attachment_id: 0}, body: {"browser_download_url" => "", "name" => ""}
  end
end
