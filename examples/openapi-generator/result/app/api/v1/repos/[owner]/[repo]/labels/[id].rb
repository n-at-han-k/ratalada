...
# /repos/{owner}/{repo}/labels/{id} -- scaffolded from the document.
...
RSpec.describe "/repos/{owner}/{repo}/labels/{id}", type: :openapi do
  openapi_schema :public_api

  api_path "/repos/{owner}/{repo}/labels/{id}" do
  ...
  it "GET /api/v1/repos/{owner}/{repo}/labels/{id} answers 200" do
    assert_api_response :get, 200, path_params: {owner: "owner", repo: "repo", id: 1}
  end

  it "DELETE /api/v1/repos/{owner}/{repo}/labels/{id} answers 204" do
    assert_api_response :delete, 204, path_params: {owner: "owner", repo: "repo", id: 1}
  end

  it "PATCH /api/v1/repos/{owner}/{repo}/labels/{id} answers 200" do
