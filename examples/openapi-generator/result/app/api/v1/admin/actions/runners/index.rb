...
# /admin/actions/runners -- scaffolded from the document.
...
RSpec.describe "/admin/actions/runners", type: :openapi do
  openapi_schema :public_api

  api_path "/admin/actions/runners" do

    get "Get all runners, no matter whether they are global runners or scoped to an organization, user, or repository" do
      tags "admin"
  ...
  "items" => Schemas::ActionRunner,
    ...
    post "Register a new global runner" do
      tags "admin"
  ...
  it "GET /api/v1/admin/actions/runners answers 200" do
    Factory[:action_runner]
    assert_api_response :get, 200
  end

  it "POST /api/v1/admin/actions/runners answers 201" do
