...
# /users/{username}/tokens -- scaffolded from the document.
...
RSpec.describe "/users/{username}/tokens", type: :openapi do
  openapi_schema :public_api

  api_path "/users/{username}/tokens" do
  ...
  "items" => Schemas::AccessToken,
    ...
    post "Generate an access token for the specified user" do
      tags "user"
  ...
  it "GET /api/v1/users/{username}/tokens answers 200" do
    Factory[:access_token]
    assert_api_response :get, 200, path_params: {username: "username"}
  end

  it "POST /api/v1/users/{username}/tokens answers 201" do
