...
# /admin/actions/runners/jobs -- scaffolded from the document.
...
RSpec.describe "/admin/actions/runners/jobs", type: :openapi do
  openapi_schema :public_api

  api_path "/admin/actions/runners/jobs" do

    get "Get action run jobs" do
      tags "admin"
  ...
  it "GET /api/v1/admin/actions/runners/jobs answers 200" do
