...
# /admin/users/{username}/tokens/{token} -- scaffolded from the document.
...
RSpec.describe "/admin/users/{username}/tokens/{token}", type: :openapi do
  openapi_schema :public_api

  api_path "/admin/users/{username}/tokens/{token}" do
    ...
    delete "Delete an access token for the specified user" do
      tags "admin"
  ...
  it "DELETE /api/v1/admin/users/{username}/tokens/{token} answers 204" do
