...
# /user/hooks -- scaffolded from the document.
...
RSpec.describe "/user/hooks", type: :openapi do
  openapi_schema :public_api

  api_path "/user/hooks" do

    get "List the authenticated user's webhooks" do
      tags "user"
  ...
  it "GET /api/v1/user/hooks answers 200" do
    Factory[:hook]
    assert_api_response :get, 200
  end

  it "POST /api/v1/user/hooks answers 201" do
